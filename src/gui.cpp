...
FindItDialog::FindItDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_gridMaterial->SetColLabelValue( 4, _("To Buy") );
	...
	m_gridMaterial->SetColLabelAlignment( wxALIGN_CENTER, wxALIGN_CENTER );

	// Rows
	m_gridMaterial->AutoSizeRows();
	m_gridMaterial->EnableDragRowSize( true );
	m_gridMaterial->SetRowLabelSize( 30 );
	m_gridMaterial->SetRowLabelAlignment( wxALIGN_CENTER, wxALIGN_CENTER );

	// Label Appearance

	// Cell Defaults
	m_gridMaterial->SetDefaultCellAlignment( wxALIGN_LEFT, wxALIGN_CENTER );
	...
	m_notebook1->AddPage( m_panel1, _("Material"), true );
	...
	m_gridFood->SetColLabelAlignment( wxALIGN_CENTER, wxALIGN_CENTER );

	// Rows
	m_gridFood->EnableDragRowSize( true );
	m_gridFood->SetRowLabelSize( 30 );
	m_gridFood->SetRowLabelAlignment( wxALIGN_CENTER, wxALIGN_CENTER );
	...
	m_gridLocations->SetColLabelAlignment( wxALIGN_CENTER, wxALIGN_CENTER );

	// Rows
	m_gridLocations->EnableDragRowSize( true );
	m_gridLocations->SetRowLabelSize( 80 );
	m_gridLocations->SetRowLabelAlignment( wxALIGN_CENTER, wxALIGN_CENTER );
	...
	m_gridUnits->SetColLabelAlignment( wxALIGN_CENTER, wxALIGN_CENTER );

	// Rows
	m_gridUnits->AutoSizeRows();
	m_gridUnits->EnableDragRowSize( true );
	m_gridUnits->SetRowLabelSize( 1 );
	m_gridUnits->SetRowLabelAlignment( wxALIGN_CENTER, wxALIGN_CENTER );

	// Label Appearance

	// Cell Defaults
	m_gridUnits->SetDefaultCellAlignment( wxALIGN_LEFT, wxALIGN_CENTER );
...
OptionsDialog::OptionsDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	wxString m_radioBox1Choices[] = { _("blank"), _("\"0\"") };
	int m_radioBox1NChoices = sizeof( m_radioBox1Choices ) / sizeof( wxString );
	m_radioBox1 = new wxRadioBox( this, wxID_ANY, _("If Value of Column \"To Buy\" = 0, set Value to"), wxDefaultPosition, wxDefaultSize, m_radioBox1NChoices, m_radioBox1Choices, 1, wxRA_SPECIFY_ROWS );
