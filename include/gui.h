...
class OptionsDialog : public wxDialog
{
	...
	public:
		...
		OptionsDialog( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("FindIt Options"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 257,257 ), long style = wxDEFAULT_DIALOG_STYLE );
